...
# Try using a 'key' parameter or something, otherwise figure out how to discern between key and username!
# Need to add logging of invalid tries!
...
def filter_on_instrument_permissions(model):
    ...
    def decorator(f):
        ...
        def wrapped(*args, **kwargs):
            ...
            # Get authorization
            key = Credentials.query.filter_by(key=request.authorization.username).first()
            if key is None:
                return unauthorized("Invalid credentials")
